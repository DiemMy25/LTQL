...
namespace LTQLSinhVien.Areas.Admin.Controllers
{
    public class SinhViensController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaSV,TenSV,GioiTinh,NgaySinh,MaLop,MaKhoa,SDT,DiaChi,email,role,password")] SinhVien sinhVien)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaSV,TenSV,GioiTinh,NgaySinh,MaLop,MaKhoa,SDT,DiaChi,email,role,password")] SinhVien sinhVien)
        {
            if (ModelState.IsValid)
            {
